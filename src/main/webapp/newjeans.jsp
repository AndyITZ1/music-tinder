...
%>
<% session.setAttribute("forum", "m+NewJeans"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="theme">
    <div id="forumName" data-name="m+NewJeans" hidden></div>
    <div class="create-post-container" id="cap-modal">
        <div class="create-post-content cap-modal-content theme">
            ...
            <form method="post" action="post">
                <!-- <label>Forum:</label> -->
                <input type="text" id="forum" name="forum" list="forums" placeholder="Forum" required>
                <datalist id="forums">
                ...
                <br>
                <!-- <label>Title:</label> -->
                <input type="text" id="title" name="title" placeholder="Title of Post" required>
                ...
                <div class="create-post-footer">
                    ...
                    <button type="submit" class="post-button" onclick="createPost()">Post</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <section class="bodywrapper">
            <div class="post-section">
            	<%
            		try {
            			conn = DriverManager.getConnection(dbJDBC, dbUser, dbPass);
            			PreparedStatement pst1 = conn.prepareStatement("SELECT forum_id FROM forum WHERE forum_name = ?");
            			pst1.setString(1, (String) session.getAttribute("forum"));
            			ResultSet rs1 = pst1.executeQuery();
            			if (rs1.next()) {
            				PreparedStatement pst2 = conn.prepareStatement("SELECT post_title, post_text, post_date, person_id FROM post WHERE forum_id = ? ORDER BY post_date DESC");
            				pst2.setInt(1, rs1.getInt("forum_id"));
            ...
            <div class="forum-section theme">
                <div class="forum-profile theme">
                    ...
                    <div class="forum-img theme" id="profile-img" onmouseover="showEdit()" onmouseout="hideEdit()">
                        <img src="images/profile.jpg" alt="Profile" id="photo">
                        <input type="file" id="file">
                        <label for="file" id="upload">
                            <img src="images/edit.png" alt="Choose Photo">
                        </label>
                    </div>
                    <div class="forum-desc">
                        <p>Welcome to the NewJeans' forum! Here we talk about the latest new girl group from Hybe Label's subsidiary Ador.</p>
                    </div>
                    ...
                    <button class="join-forum">Join</button>
                </div>
            </div>
        </section>
    </div>
    ...
    <script src="js/newjeans.js" type="text/javascript"></script>
